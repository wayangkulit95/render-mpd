...
# Setup script to install dependencies, configure domain, and set up Nginx with SSL for the Express app.
...
# Step 7: Set up Nginx configuration for the domain
...
# Step 9: Add Cron job for automatic SSL renewal
echo "Setting up SSL certificate renewal..."
sudo crontab -l > mycron
echo "0 0,12 * * * certbot renew --quiet && systemctl reload nginx" >> mycron
sudo crontab mycron
rm mycron

# Step 10: Instructions to start the app
echo "Setup complete!"
